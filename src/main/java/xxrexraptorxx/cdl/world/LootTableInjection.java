...
import xxrexraptorxx.cdl.utils.mixins.LootTableAccessor;
        ...
        if (name.startsWith(prefix)) {
            ...
            if (INJECTION_TABLES.containsKey(file)) {
                try {
                    ...
                    CDL.LOGGER.error("Loottable {} is broken by some other mod. Cannot add " + References.NAME + " loot to it. " + name);
                }
            }
        }
    }
